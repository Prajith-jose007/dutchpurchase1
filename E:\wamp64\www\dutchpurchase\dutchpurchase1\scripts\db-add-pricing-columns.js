...
// Create the connection pool directly within the script to avoid import issues.
...
async function addPricingColumns() {
  ...
  try {
    ...
    // For a script, it's good practice to end the pool to allow the process to exit cleanly.
    await pool.end();
  }
}
